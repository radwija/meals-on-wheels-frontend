...
export const Navbar = () => {
    ...
    return (
        <nav className="fixed mx-auto w-full top-0 z-20 bg-white border-b border-gray-200">
            <div div className="max-w-screen-xl flex flex-wrap items-center mx-auto p-4" >
                ...
                <div className="mx-auto items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
