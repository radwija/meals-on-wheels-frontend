                ...
                <div className="flex items-center md:order-2">
                    {
                        !auth() ?
                            ...
                            <div className="md:flex  items-center">
                                ...
                                <button onClick={() => handleProfileExpand()} id="user-menu-button" type="button" className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                    ...
                    {/* <!-- Dropdown menu --> */}
                    {
                        auth() && isProfileExpanded ?
                            <div id="user-dropdown" className="z-50 absolute right-12 top-12 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" >
