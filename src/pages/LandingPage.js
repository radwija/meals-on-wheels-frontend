    ...
    return (
        <Layout>
            ...
            <section className='my-52 sm:flex sm:flex-wrap sm:flex-col md:grid md:grid-cols-12 p-5 '>
                ...
                <div className='lg:px-20 md:px-3 py-5 lg:text-left md:text-left sm:text-left sm:col-span-12 md:col-span-6'>
                    <h1 className='text-4xl md:text-5xl font-semibold mb-6 text-center sm:text-center'>Our Commitment</h1>
